  ...
  <div class="container">
    <form id="__form_post__gambar" enctype="multipart/form-data">
      <ul>
        ...
        <li v-show="captionProperti">
          <button
            class="__btn_kirim_post"
            :disabled="disabledBtnAddFoto"
            v-on:click.prevent="postFoto"
          >
...
export default {
  ...
  methods: {
    imageProcess(event) {
      ...
      axios
        .post("/api/validasi_file_", dataForm, {
          headers: {
