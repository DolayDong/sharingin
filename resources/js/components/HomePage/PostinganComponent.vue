  ...
  <div class="home-post">
    <div class="container add-post">
      <ul>
        <li>
          <img
            class="image_profile"
            :src="dataUser.data.photo_profile"
            alt="profile"
          />
        </li>
        <li>
    ...
    <div class="postingan-teman">
      <div
        ...
        v-for="postingan in postingans"
        v-bind:key="postingan.id"
      >
        <div class="card-header header-postingan">
          <img :src="postingan.user.data.photo_profile" alt="profile" v-on:click.prevent="halamanProfile(postingan.user.name)"/>
          <ul>
            <li>
        ...
        <div class="card-footer footer-postingan">
          <div class="container">
            <ul>
              ...
              />
              <button-comment-component :post-id="postingan.id" :jumlah-comment="postingan.comments.length"/>
              <li>
...
export default {
  ...
  methods: {
    ...
    halamanProfile(nama){
      return this.$router.push({path: '/user/', name: 'profile', params: {user: nama}})
    }
  },
};
</script>
